...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { marca: @compra.marca, quantidade: @compra.quantidade, valor: @compra.valor } }, as: :json
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { marca: @compra.marca, quantidade: @compra.quantidade, valor: @compra.valor } }, as: :json
    assert_response 200
  end
